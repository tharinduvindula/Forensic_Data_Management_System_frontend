...
@Component({
  selector: 'app-user-profile-view-lecture',
  templateUrl: './user-profile-view-lecture.component.html',
  styleUrls: ['./user-profile-view-lecture.component.scss']
})
export class UserProfileViewLectureComponent implements OnInit {
  users: USER;
  error: any;
