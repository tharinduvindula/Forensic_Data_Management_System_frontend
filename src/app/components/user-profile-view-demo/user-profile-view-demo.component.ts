...
@Component({
  selector: 'app-user-profile-view-demo',
  templateUrl: './user-profile-view-demo.component.html',
  styleUrls: ['./user-profile-view-demo.component.scss']
})
export class UserProfileViewDemoComponent implements OnInit {
  users: USER;
  error: any;
